...
<body>
<form name="form1" action="adminc.php" method="post">  
</tr>
   <tr>
...
echo $add;
$sql="INSERT INTO table4 (name,phone,address,exp) values ('{$_POST["t1"]}','{$_POST["t2"]}','{$add}','{$_POST["t4"]}')";
echo $sql;             
...
{
   $sql = "DELETE FROM table4 WHERE name='{$_POST["t1"]}' ";
  ...
  if(isset($_POST['submit4']))
{
     ...
     $sql = "UPDATE table4 SET  phone='{$_POST["t2"]}' ,address='{$_POST["t3"]}',exp='{$_POST["t4"]}'   WHERE name='{$_POST["t1"]}' ";
